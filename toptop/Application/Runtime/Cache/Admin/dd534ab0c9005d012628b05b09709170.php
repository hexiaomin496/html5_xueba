    ...
    <div class="row content">
        ...
        <div class="col-md-10 col-xs-10 right">
            ...
            <div class="buttongroup">
                <div class="grop1">
                    <form action="<?php echo U('Admin/questions/search');?>" class="navbar-form" role="search" method="post">
            ...
            <div class="tablegroup">
                <table class="table">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><a href="/toptop/index.php/Admin/Questions/edit/id/<?php echo ($data["que_id"]); ?>">查看</a></td>
                        <td><a href="/toptop/index.php/Admin/Questions/del/id/<?php echo ($data["que_id"]); ?>">删除</a></td>
                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    <tr class="table-bottom">
                        <td><input type="checkbox" name="test" value="" onclick="if(this.checked==true) { checkAll('test'); } else { clearAll('test'); }"></td>
                        <td style="text-align:left">全选<a href="#" class="button4">批量删除</a></td>
