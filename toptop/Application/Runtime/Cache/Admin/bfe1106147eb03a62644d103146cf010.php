...
<head>
    ...
    <link href="/toptop/Public/admin/css/styleww.css" rel="stylesheet">
</head>
...
<div class="container-fluid">
	<div class="row content">
        ...
        <form action="<?php echo U('Admin/answers/del');?>/ids/<?php echo ($list["ans_id"]); ?>/idq/<?php echo ($list["ans_que_id"]); ?>" method="post">
		<div class="col-md-10 col-xs-10 right">
            ...
            <div class="row content-righh">
                ...
                <div class="col-md-10 col-xs-10 rightww">
                    <p><?php echo ($list["ans_username"]); ?></p>
                </div>
            </div>
            <div class="row content-righh">
                <div class="col-md-2 col-xs-2 lefttt">
