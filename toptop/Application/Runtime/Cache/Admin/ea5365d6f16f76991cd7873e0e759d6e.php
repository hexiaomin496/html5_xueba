...
<head>
    ...
    <link href="/toptop/Public/admin/css/bootstrap.min.css" rel="stylesheet">
    <link href="/toptop/Public/admin/css/style.css" rel="stylesheet">
</head>
        ...
        <div class="col-md-10 col-xs-10 right">
                ...
                <div class="grop1">
                    <form action="<?php echo U('Admin/answers/search');?>" class="navbar-form" role="search" method="post">
                       <div class="form-group">
                        <input type="text" name="search_value" class="form-control" style="margin-top:-4px;">
            ...
            <form action="<?php echo U('Admin/answers/destory');?>" method="post">
                <table class="table">
                    ...
                    <?php if(is_array($studentquestiontab)): $i = 0; $__LIST__ = $studentquestiontab;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><tr>
                        <td><input type="checkbox" name="id[]" id = "id[]" value="<?php echo ($data["ans_id"]); ?>+<?php echo ($data["ans_que_id"]); ?>"></td>
                        <td title="<?php echo ($data["que_content"]); ?>"><a target="_blank" href="<?php echo U('Admin/answers/edit');?>/ids/<?php echo ($data["ans_id"]); ?>/idq/<?php echo ($data["ans_que_id"]); ?>" title="<?php echo ($data["que_content"]); ?>"><?php echo ($data["ans_content"]); ?></a></td>
                        <td title="<?php echo ($data["que_content"]); ?>"><a target="_blank" href="<?php echo U('Admin/answers/edit');?>/ids/<?php echo ($data["ans_id"]); ?>/idq/<?php echo ($data["ans_que_id"]); ?>" title="<?php echo ($data["que_content"]); ?>"><?php echo ($data["que_content"]); ?></a></td>
...
<script src="/toptop/Public/admin/js/jquery.min.js"></script>
<script src="/toptop/Public/admin/js/bootstrap.min.js"></script>
<script src="/toptop/Public/admin/js/scripts.js"></script>
</body>
</html>