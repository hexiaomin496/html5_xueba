            ...
            <div class="buttongroup">
            	<form action="">
                    <div class="file-box">  
                        ...
                        <input type="file" name="fileField" class="file" id="fileField" size="28" onchange="document.getElementById('textfield').value=this.value" accept="application/ogg,audio/ogg,audio/mp4, video/mp4,audio/mpeg" /> 
                    </div>
                    <a href="<?php echo U('Admin/videos/create');?>" class="button2">上传视频文件</a>
                    日期：
                    <input type="date" value="" name="">
                    至
                    <input type="date" value="" name="">
                    <a href="#" class="button3">查询</a>
                </form>
            </div>
