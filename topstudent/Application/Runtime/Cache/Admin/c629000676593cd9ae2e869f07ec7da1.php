...
<div class="container-fluid">
	<div class="row content">
        	...
        	<div class="panel-group" id="accordion">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                        <div class="panel-body">
                        	<ul>
                            	<li><a href="问答管理-用户列表.html">用户列表</a></li>
                                <li><a href="问答管理-教师管理.html">教师管理</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
		...
		<div class="col-md-10 col-xs-10 right">
        	<h1>课本编辑</h1>
            <form action="<?php echo U('Admin/books/save');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
            <div class="rightcon">
                ...
                <table class="form">
                	...
                	<tr>
                        ...
                        <td><input type="text" name="book_title" value="<?php echo ($books["book_title"]); ?>"></td>
                    </tr>
                    <tr>
                    	<td>课本简介：</td>
                        <td rowspan="2"><textarea name="book_content"><?php echo ($books["book_content"]); ?></textarea></td>
                    </tr>
                    <tr>
                    	<td>&nbsp;</td> 
                    </tr>
                    <tr>
                        ...
                        <td><select name="book_types">
                			<option ><?php echo ($books["book_types"]); ?></option>
                            <option >语文</option>
                            <option >数学</option>
                             <option >英语</option>
                		</select></td>
