...
<div class="header">
	<div class="mybody">
        ...
        <div class="login">
        	...
        	<a href="/topstudent/index.php/Home/users/logout">退出</a>
        </div>
        <ul class="nav">
...
<div class="content">
	<div class="mybody">
        ...
        <div class="personal_left">
        	<div class="user">
            	<a href="#"><img src="/topstudent/Public/<?php echo ($user['user_img']); ?>" width="157" height="157" alt="user" /></a>
            ...
            <ul class="left_nav">
                    ...
                    <li class="left_nav_now"><a href="">个人管理</a></li>
        ...
        <div class="form1">
            ...
            <form action="/topstudent/index.php/Home/personal/editImg" method="post" enctype="multipart/form-data">
            <div class="img">
            	
            	<div class="file-box">  
                     <input type='button' /> 
                     <img src="/topstudent/Public/<?php echo ($user['user_img']); ?>" class='useradd' width = '150' height='150'/>
           ...
           <form action="/topstudent/index.php/Home/personal/edit" method="post" name="usertab">
