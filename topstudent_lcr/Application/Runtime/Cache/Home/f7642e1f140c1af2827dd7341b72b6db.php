...
<div class="content">
	<div class="mybody">
        ...
        <div class="personal_form_right">
            ...
            <div class="exper">
            	<div class="userhead"><img src="/topstudent/Public/home/images/user_s.jpg" width="100" height="100" alt="" /></div>
                <div class="schedule">
                    <div class="am-progress am-progress-striped">
                        <div class="am-progress-bar am-progress-bar-secondary" style="width: 77%"></div>
                    </div>
                </div>
                <div class="number">
                	<div class="h2">77/100</div>
                    <div class="h3">LV3</div>
                </div>
            </div>
