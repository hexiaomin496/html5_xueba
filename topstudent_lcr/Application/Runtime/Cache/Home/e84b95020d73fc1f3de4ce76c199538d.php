...
<div class="mybody">
    ...
    <div class="right">
    	<div class="righttop">
            ...
            <div class="xzdr">
       	    	<img src="/topstudent/Public/<?php echo ($listss["head_picture"]); ?>" width="150" height="190" alt="dr" class="xzdrimg"/>
                <div class="xzright">
                <div class="drname">
 ...
 $str1 = $listss['score']; $str2 = $str1/100; echo LV.intval($str2); ?>
    	...
    	<div class="righttop righttop2">
            ...
            <ul class="topul">
            <?php if(is_array($llist)): $i = 0; $__LIST__ = $llist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Home/personal/hotquedetails');?>/qid/<?php echo ($data["que_id"]); ?>"><?php echo ($data["content"]); ?></a><span><?php $str = $data['publish']; echo substr($str,5,5); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="left">
      ...
      <div class="qtop">
        ...
        <li>
            <h3>我要回答：</h3>
                <form action="<?php echo U('Home/personal/addanswers');?>" method="post">
                    <textarea placeholder="请输入回答内容" id="content" name="content" class="text"></textarea>
 ...
 $str1 = $data['user_score']; $str2 = $str1/100; echo LV.intval($str2); ?>
                    ...
                    <div class="ssfl ssfl2 ssflul" id="zan"><img src="images/dz.png" width="15" height="15" alt="sj" id="zanimg"/>
                    <span id="zanshu">3赞</span></div>
...
<script>
    ...
    zan.onclick=function(){
        zanimg.src="/topstudent/Public/home/images/dzh.png";
