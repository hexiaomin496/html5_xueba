...
<div class="mybody">
 ...
 $str1 = $listss['score']; $str2 = $str1/100; echo LV.intval($str2); ?>
    ...
    <div class="left">
        ...
        <form  action="<?php echo U('Home/learnansq/ask');?>" method="post">
           <button type="submit" value="我要提问" class="searchbutton searchbutton2">我要提问</button>
        </form>
        
   		</div>
        <div class="lp">
    	<ul>
    		<li><a href="#" class="lpli">小学</a></li>
            <li><a href="#" class="lphover">初中</a></li>
        	<li><a href="#" class="lpli">语文</a></li>
        	<li><a href="#" class="lpli">数学</a></li>
        	<li><a href="#" class="lpli">英语</a></li>
    	</ul>
        </div>
        <ul class="proul">
