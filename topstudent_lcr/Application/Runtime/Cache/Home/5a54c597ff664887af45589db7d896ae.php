...
<div class="content">
<div class="mybody">
	<div class="bread"><span>学霸养成</span> > <a href="<?php echo U('Home/learnansq/index');?>">学霸问答</a> > <a href="#">问答详情</a></div>
    <div class="right">
    	<div class="righttop">
    ...
    <div class="left">
      ...
      <div class="qtop">
        ...
        <?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li>
            	<div class="lileft">
           	    <img  class="headimg" src="/topstudent/Public/home/images/head.gif" width="80" height="80" alt="head" />
                </div>
                <div class="liright">
                	<div class="rtop">
