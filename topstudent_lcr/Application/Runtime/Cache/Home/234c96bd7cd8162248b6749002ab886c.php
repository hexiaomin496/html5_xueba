...
<div class="header">
	<div class="mybody">
        ...
        <div class="login">
        	欢迎你&nbsp;<?php echo ($_SESSION['user_username']); ?>&nbsp;&nbsp;<a href="/topstudent/index.php/Home/users/logout">退出</a>
        </div>
        <ul class="nav">
        	<li><a href="">首页</a></li>
            ...
            <li class="navnow"><a href="<?php echo U('index');?>">个人中心</a></li>
        </ul>
    </div>
</div>
<div class="ad">
...
<div class="content">
	<div class="mybody">
        ...
        <div class="personal_left">
            ...
            <ul class="left_nav">
            		<li class="left_nav_now"><a href="">首页</a></li>
        ...
        <div class="personal_form_right">
            ...
            <div class="exper">
            	<div class="userhead"><img src="/topstudent/Public/<?php echo ($user['user_img']); ?>" width="100" height="100" alt="" /></div>
                <div class="schedule">
                    <div class="am-progress am-progress-striped">
                    <?php
 $score = $user['user_score']; $a = $score/100; $a = floor($a); $b = $score%100; ?>
