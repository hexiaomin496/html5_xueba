...
<link href="/topstudent/Public/home/css/projectlist.css" rel="stylesheet" type="text/css" />
...
<div class="mybody">
    ...
    <div class="right">
    	<div class="righttop">
            ...
            <div class="xzdr">
                ...
                <div class="xzright">
                <div class="drname">
                <h1><?php echo ($lists["user_username"]); ?></h1>
                <span>
                    <?php
 $str1 = $listss['score']; $str2 = $str1/100; echo LV.intval($str2); ?>
    	...
    	<div class="righttop righttop2">
            ...
            <ul class="topul">
        	<?php if(is_array($llist)): $i = 0; $__LIST__ = $llist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Home/learnansq/hotlquedetails');?>/qid/<?php echo ($data["que_id"]); ?>"><?php echo ($data["content"]); ?></a><span><?php echo ($data["publish"]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        </div>
    </div>
    <div class="left">
    	...
    	<form action="<?php echo U('Home/learnansq/search');?>" method="post">
           ...
           <a href="<?php echo U('Home/learnansq/ask');?>" value="我要提问" class="searchbutton searchbutton2">我要提问</a>
        </form>
        ...
        <div class="lp">
    	<ul>
    		<li><a href="<?php echo U('Home/learnansq/primary');?>" class="lphover">小学</a></li>
            <li><a href="<?php echo U('Home/learnansq/middle');?>" class="lpli">初中</a></li>
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li>
                ...
                <div class="time">
               	    	<img src="/topstudent/Public/home/images/time.gif" width="14" height="14" alt="time"/> 
