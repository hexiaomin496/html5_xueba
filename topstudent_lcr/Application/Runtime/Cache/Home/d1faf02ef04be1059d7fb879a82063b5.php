...
<link href="/topstudent/Public/home/css/setquestion.css" rel="stylesheet" type="text/css" />
<title>我要提问</title>
</head>
<body>
<div class="header">
...
<div class="content">
<div class="mybody">
	<div class="bread"><span>您现在的位置</span> > <a href="<?php echo U('Home/learnansq/index');?>">学霸问答</a> > <a href="#">我要提问</a></div>
    <div class="quesform">
    	<div class="questop">
    	<h1 class="title">问题</h1>
        <form action="<?php echo U('Home/learnansq/asksubmit');?>" method="post">
        	<textarea class="text" name="title" id="title"></textarea>
        </div>
        <div class="questop">
        <h1 class="title">分类</h1>
        <select class="select" name="pag" id="pag">
        	<option>语文</option>
            <option>数学</option>
            <option>英语</option>
            <option>小学</option>
    	...
    	<h1 class="title">详情</h1>
        	<textarea class="text text2"  name="content" id="content"></textarea>
        </div>
        
        <div class="questop">
        	<button type="submit" value="发布问题" name="" class="button">发布问题</button>
        </div>
        </form>
    </div>
</div>
