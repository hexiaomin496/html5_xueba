...
<div class="mybody">
 ...
 $str1 = $listss['score']; $str2 = $str1/100; echo LV.intval($str2); ?>
        ...
        <div class="righttop righttop2">
            ...
            <ul class="topul">
            <?php if(is_array($llist)): $i = 0; $__LIST__ = $llist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Home/learnansq/lquedetails');?>/qid/<?php echo ($data["que_id"]); ?>"><?php echo ($data["content"]); ?></a><span><?php echo ($data["publish"]); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="left">
      ...
      <div class="qtop">
        ...
        <li>
            <h3>我要回答：</h3>
                <form action="<?php echo U('Home/learnansq/addanswers');?>" method="post">
