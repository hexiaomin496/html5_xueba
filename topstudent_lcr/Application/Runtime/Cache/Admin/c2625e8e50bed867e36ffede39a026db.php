...
<div class="container-fluid">
	<div class="row content">
		...
		<div class="col-md-10 col-xs-10 right">
        	<h1>视频编辑</h1>
            <div class="rightcon">
            	<video src="/topstudent/Public/<?php echo($videos['video']); ?>" controls onPause loop id="video" width="400px" height="300px"></video>
                <div class="buttongroup">
                <form method="post" action="/topstudent/index.php/Admin/videos/save" name="videos">
                <table class="form">
                	<input name="video_id" value="<?php echo ($videos["video_id"]); ?>" style="display:none;" />
                	<tr>

                    	<td style="width:86px;">视频标题：</td>
                        <td><input type="text" value="<?php echo ($videos["video_title"]); ?>" name="video_title"></td>
                    </tr>
                    <tr>
                    	<td>视频简介：</td>
                        <td rowspan="2"><textarea name="video_content" value=''><?php echo ($videos["video_content"]); ?></textarea></td>
                    </tr>
                    <tr>
                    	<td>&nbsp;</td> 
                    </tr>
                    <tr>
                    	<td>上传封面：</td>
                        <td><input type="file" name="video_img" class="videoimg" accept="image/jpeg,image/gif,image/png,image/jpg" /><?php echo ($videos["video_img"]); ?></td>
                    </tr>
                   
                    <tr>
                    	<td>分类标签：</td>
                        <td><select name="video_type">
                        	<option><?php echo ($videos["video_type"]); ?></option>
                			<option >真污</option>
                            <option>辣鸡</option>
                            <option>恶心</option>
                		</select></td>
