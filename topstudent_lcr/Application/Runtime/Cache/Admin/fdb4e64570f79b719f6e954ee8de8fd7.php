    ...
    <div class="row content">
        ...
        <div class="col-md-10 col-xs-10 right">
			...
			<div class="buttongroup">
            	<form action="/topstudent/index.php/Admin/user/searchTea" method="post" class="navbar-form">
            		<div class="form-group">
            			<input type="text" class="form-control" name="user_name" placeholder="请输入老师名字"　style="margin-top:-4px;">
            		</div>
                    <button type="submit" class="btn button1" name="user_name">搜索</button>
            ...
            <div class="tablegroup">
                ...
                <?php if(is_array($teacher)): $i = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tea): $mod = ($i % 2 );++$i;?><tr>
