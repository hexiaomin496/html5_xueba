	...
	<div class="row content">
		...
		<div class="col-md-10 col-xs-10 right">
			...
			<div class="buttongroup">
                ...
                <div class="col-md-6 col-xs-6 left">
                    <form action="/topstudent/index.php/Admin/tests/query" method="post" name="tests2">
                    日期：
            ...
            <div class="tablegroup">
            	...
            	<form action="/topstudent/index.php/Admin/tests/deleteAll" method="get">
                    ...
                    <?php if(is_array($tests2)): $i = 0; $__LIST__ = $tests2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$te): $mod = ($i % 2 );++$i;?><tr>
