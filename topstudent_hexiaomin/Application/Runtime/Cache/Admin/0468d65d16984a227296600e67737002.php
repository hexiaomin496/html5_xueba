	...
	<div class="row content">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse in">
                        <div class="panel-body">
                        	<ul>
                                ...
                                <li class="linow"><a href="<?php echo U('Admin/admins/add');?>">添加管理员</a></li>
		...
		<div class="col-md-10 col-xs-10 right">
            ...
            <div class="rightcon">
                ...
                <form role="form" method="post" action="/topstudent/index.php/Admin/Admins/doAdd">
                <table class="form">
                	<tr>
                    	<td style="width:86px;">用户名：</td>
                        <td><input type="text" value="" name="adm_username"></td>
                    </tr>
                    <tr>
                    	<td>真实姓名：</td>
                        <td><input type="text" value="" name="adm_name"></td>
                    </tr>
                    <tr>
                    	<td>电子邮箱：</td>
                        <td><input type="text" value="" name="adm_email"></td>
                    </tr>
                    <tr>
                    	<td>添加时间：</td>
                    ...
                    <tr>
                    	<td>设置密码：</td>
                        <td><input type="password" value="" name="adm_password"></td>
                    </tr>
                    <tr>
                    	<td>确认密码：</td>
                        <td><input type="password" value="" name="amd_pswd"></td>
                    </tr>
                    <tr>
                    	<td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                    	<td>&nbsp;</td>
                        <td><button type="submit" class="btn button" >添加</button></td>
                    </tr>
                    <tr>
                    	<td>&nbsp;</td>
                        <td>&nbsp;</td>
