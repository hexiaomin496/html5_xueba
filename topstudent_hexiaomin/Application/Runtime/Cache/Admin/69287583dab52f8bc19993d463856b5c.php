        ...
        <div class="col-md-10 col-xs-10 right">
            ...
            <div class="buttongroup">
                <div class="col-md-6 col-xs-6 left">
                    <form action="<?php echo U('Admin/answers/search');?>" class="navbar-form" role="search" >
                       <div class="form-group">
                        <input type="text" name="search_value" class="form-control" value="<?php echo ($_POST['search_value']); ?>" style="margin-top:-4px;">
