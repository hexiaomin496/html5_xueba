	...
	<div class="row content">
                    ...
                    <div id="collapseFour" class="panel-collapse collapse in">
                        <div class="panel-body">
                        	<ul>
                                ...
                                <li class="linow"><a href="<?php echo U('Admin/admins/edit');?>">个人密码修改</a></li>
                            </ul>
                        </div>
                    </div> 
                </div>
		...
		<div class="col-md-10 col-xs-10 right">
            ...
            <div class="rightcon">
                ...
                <form role="form" method="post" action="/topstudent/index.php/Admin/Admins/doEdit" enctype="multipart/form-data">
                <table class="form" name="user" id="user" ><!--  -->
                     <input type="hidden" name="adm_id" value="<?php echo ($_SESSION['userid']); ?>" />
                	<tr>
                    ...
                    <tr>
                    	<td>真实姓名：</td>
                        <td><input type="text" name="adm_name" value="<?php echo ($user["adm_name"]); ?>" readonly></td>
                    </tr>
                    <tr>
                    	<td>旧密码：</td>
                        <td><input type="password"  value="<?php echo ($user["adm_password"]); ?>"></td>
                    </tr>
                    <tr>
                    	<td>新密码：</td>
                        <td><input type="password" name="adm_password" value=""></td>
                    </tr>
                    <tr>
                    	<td>确认密码：</td>
                        <td><input type="password" name="adm_repswd"  value=""></td>
                    </tr>
                    <tr>
                    	<td>&nbsp;</td>
                        <td>&nbsp;</td>
                    ...
                    <tr>
                    	<td>&nbsp;</td>
                        <td><button class="btn button1" type="submit">保存</button></td>
                    </tr>
                    <tr>
                    	<td>&nbsp;</td>
                        <td>&nbsp;</td>
